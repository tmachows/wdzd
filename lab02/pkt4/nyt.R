...
writeLines("30 elements with highest values for first component (music):")
signif(sort(nyt.latent.sem[, 1], decreasing = TRUE)[1:30], 2)
writeLines("")

writeLines("30 elements with lowest values for first component (music):")
signif(sort(nyt.latent.sem[, 1], decreasing = FALSE)[1:30], 2)
writeLines("")

writeLines("30 elements with highest values for second component (art):")
signif(sort(nyt.latent.sem[, 2], decreasing = TRUE)[1:30], 2)
writeLines("")

writeLines("30 elements with lowest values for second component (art):")
